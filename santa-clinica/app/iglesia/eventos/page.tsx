...
import { Calendar, Clock, MapPin, Users, Plus, Search, Filter, X, FileText } from 'lucide-react'
...
const events = [
  { id: 1, name: "Servicio Dominical", date: "2024-10-06", time: "10:00", location: "Auditorio Principal", attendees: 150 },
  { id: 2, name: "Estudio Bíblico", date: "2024-10-08", time: "19:00", location: "Sala de Conferencias", attendees: 30 },
  { id: 3, name: "Retiro de Jóvenes", date: "2024-10-15", time: "08:00", location: "Campamento El Redentor", attendees: 50 },
]
...
function NuevoEventoModal({ isOpen, onClose }) {
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <Select id="type">
              ...
              <option value="Alcance">Alcance Comunitario</option>
            </Select>
          </div>
...
function DetalleEventoModal({ isOpen, onClose, event }) {
...
export default function EventosPage() {
  ...
  const handleOpenDetalleEvento = (event) => {
